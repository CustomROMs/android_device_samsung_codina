...
TARGET_KERNEL_BINARIES: $(KERNEL_OUT) $(KERNEL_CONFIG) $(KERNEL_HEADERS_INSTALL) $(uncompressed_ramdisk)
...
#$(INSTALLED_RECOVERYIMAGE_TARGET): $(INSTALLED_KERNEL_TARGET) $(recovery_uncompressed_ramdisk)
	$(ACP) -fp $< $@
